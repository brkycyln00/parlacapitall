    ...
    <div className="home-page">
      ...
      <section className="hero-section pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-20 left-20 w-64 h-64 bg-amber-500 rounded-full filter blur-[100px]"></div>
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-blue-500 rounded-full filter blur-[100px]"></div>
        </div>
